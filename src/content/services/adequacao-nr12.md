---
title: Adequação NR-12 em São Paulo | Máquinas e Equipamentos
slug: adequacao-nr-12-maquinas-equipamentos
shortDescription: Adequação NR-12 para máquinas e equipamentos em São Paulo, com
  inventário, apreciação de riscos, projeto de adequação e laudo técnico com
  ART.
description: Executamos projetos de adequação NR-12 para máquinas e equipamentos
  industriais, incluindo inventário de máquinas, apreciação de riscos, definição
  de medidas de proteção, projeto mecânico e elétrico, documentação técnica e
  laudo final com ART. Atendimento em São Paulo e em todo o brasil, para
  adequação legal, redução de riscos e continuidade operacional.
image: /uploads/1.jpg
order: 1
icon: shield-check
...
A adequação conforme a **NR-12** envolve a análise das condições reais de funcionamento das máquinas, a identificação de perigos e não conformidades, a elaboração da **apreciação de riscos** e a definição de soluções técnicas compatíveis com a operação, manutenção, limpeza, setup e demais intervenções realizadas pelos trabalhadores. O objetivo é conciliar **segurança, conformidade legal e viabilidade operacional**.
...
* reformas, retrofits e modernizações;
* expansão de linhas produtivas;
...
* Apreciação de riscos (APR/HRN)
* Análise de acessos, pontos de operação e zonas perigosas
* Projeto de adequação mecânica e elétrica
* Concepção de proteções fixas, móveis e intertravadas
* Definição de medidas de proteção coletiva e dispositivos de segurança
* Definição de requisitos para paradas de emergência e sistemas de comando
* Instalação de dispositivos de segurança
* Recomendações para sinalização, procedimentos e capacitação
...
* Linhas automáticas e semiautomáticas
* Dispositivos e máquinas especiais
* Máquinas com partes móveis expostas
* Máquinas de usinagem como tornos, fresas e furadeiras
* Máquinas de conformação como prensas, dobradeiras e forjas
...
* Redução de exposição a multas, embargos e interdições
* Melhor organização documental da segurança de máquinas
...
Se a sua empresa precisa de **adequação NR-12 para máquinas e equipamentos**, **apreciação de riscos**, **laudo técnico** ou **projeto de regularização**, entre em contato para avaliar o escopo e as necessidades da aplicação.
