...
slug: terceirizacao-mao-de-obra-engenharia
shortDescription: Fornecimento de profissionais técnicos para projetos de
  engenharia industrial — gestores, desenhistas, técnicos e administrativo.
description: Alocação de profissionais qualificados para projetos de engenharia
  industrial, do gerenciamento ao suporte técnico e administrativo.
...
* Engenheiros
* Projetistas e desenhistas CAD/CAD 3D
* Técnicos de acompanhamento e fiscalização de obras
* Planejadores e controladores de cronograma (MS Project / Primavera P6)
* Analistas de controle de custos e orçamento CAPEX
