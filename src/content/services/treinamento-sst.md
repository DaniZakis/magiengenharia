...
slug: laudo-ergonomico-nr-17
shortDescription: Elaboração de Laudo Ergonômico e AET conforme NR-17, com
  análise das condições de trabalho e recomendações técnicas.
description: Laudo Ergonômico e Análise Ergonômica do Trabalho (AET) conforme
  NR-17, com avaliação de postos de trabalho, mobiliário, equipamentos e
  organização do trabalho.
image: /uploads/ergonomia.jpg
order: 11
icon: academic-cap
category: Capacitação
benefits:
  - Diminuição do passivo trabalhista
  - Suporte na implantação das ações
  - Consultoria técnica em todo o processo
  - Validade Jurídica
relatedServices:
  - adequacao-nr12
  - linha-de-vida-nr35
...
* Avaliação de postos de trabalho e layout industrial
* Análise de mobiliário, equipamentos e ferramentas de trabalho
* Avaliação de levantamento, transporte e movimentação de cargas
* Identificação e quantificação de riscos ergonômicos e LER/DORT
