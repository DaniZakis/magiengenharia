...
slug: gestao-de-projetos-de-engenharia
shortDescription: Gestão de projetos industriais e CAPEX do conceitual ao
  comissionamento, com planejamento, cronograma e controle conforme PMBOK.
description: Gestão completa de projetos industriais e CAPEX, da concepção ao
  startup, com planejamento, controle de escopo, prazo e custo conforme PMBOK.
image: /uploads/9.jpg
order: 9
icon: link
category: Documentação Técnica
benefits:
  - Gestão Baseada no PMBOK; Controle Total do CAPEX; Redução de Riscos e
    Retrabalhos; Gestão Completa do CAPEX e OPEX; Planejamento e Cronograma
    Estruturado
---
...
* Controle e gestão de orçamento CAPEX e OPEX
* Coordenação multidisciplinar de projetos de engenharia
* Gestão de contratos, licitações e fornecedores
* Controle de documentação e gestão de mudanças (MOC)
* Gerenciamento de riscos e caminhos críticos
* Acompanhamento de fabricação e instalação
