---
title: NR-20 - Área Classificada, Inflamáveis e Combustíveis
slug: nr-20-area-classificada-inflamaveis-combustiveis
shortDescription: Laudo NR-20, área classificada e prontuário de inflamáveis e
  combustíveis. Atenda à norma e evite multas, riscos de incêndio e interdições.
description: "Serviços completos em NR-20: elaboração de prontuário,
  classificação de áreas e laudo técnico para inflamáveis e combustíveis, com
  ART e conformidade legal."
image: /uploads/tank-nr-20.jpg
order: 2
icon: fire
category: Documentação Técnica
benefits:
  - Classificação de área com memorial técnico detalhado
  - Documentação aceita em auditorias seguradoras e vistorias do Corpo de
    Bombeiros
  - Prontuário completo e atualizado conforme NR-20
  - Atualização periódica
  - Suporte técnico das adequações
relatedServices:
  - gestao-sst-esocial
  - laudos-tecnicos
  - treinamento-sst
---
A NR-20 exige que empresas que armazenam, manuseiam ou operam com inflamáveis e combustíveis mantenham documentação técnica atualizada e instalações seguras.

Realizamos a determinação de área classificada, elaboração e atualização de prontuário NR-20, além da emissão de laudo técnico com ART por Profissional Legalmente Habilitado (PLH), garantindo conformidade legal e segurança operacional.

A não conformidade pode resultar em multas, interdições e riscos graves de incêndio e explosão.
...
* Levantamento e mapeamento de inflamáveis e combustíveis (Classe I, Classe II e Classe III)
* Determinação e delimitação de área classificada
* Classificação de zonas de risco (Zona 0, Zona 1 e Zona 2)
* Avaliação de atmosferas explosivas
* Verificação de equipamentos e instalações elétricas em área classificada
* Elaboração de prontuário NR-20
...
* Empresa especializada em NR-20 e áreas classificadas
* Aprovação em seguradoras e certificadoras
...
* Operações com solventes e gases inflamáveis
* Galpões industriais com risco de atmosfera explosiva
...
É uma área onde pode ocorrer a formação de atmosfera explosiva devido à presença de gases, vapores ou poeiras inflamáveis.

**Quem pode emitir laudo NR-20?**
...
Entre em contato para análise de área classificada, elaboração de prontuário e emissão de laudo NR-20 com ART.
