        ...
        <div>
          ...
          <div class="space-y-2 text-sm">
            <p>
              ...
              <a href="tel:+5511999999999" class="hover:text-accent transition-colors">
                +55 (11) 9999-9999
              </a>
            </p>
            <p>
              <strong>WhatsApp:</strong>
              <a href="https://wa.me/5511999999999" target="_blank" rel="noopener noreferrer" class="hover:text-accent transition-colors">
                Chat
              </a>
            </p>
            <p>
              <strong>Email:</strong>
              <a href="mailto:contato@maggi.com.br" class="hover:text-accent transition-colors">
                contato@maggi.com.br
              </a>
            </p>
            <p>
        ...
        <div class="flex space-x-4">
          ...
          >
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5c-.563-.074-1.396-.154-2.783-.154-2.386 0-4.232 1.455-4.232 4.32v1.834z" />
            </svg>
          </a>
          <a
