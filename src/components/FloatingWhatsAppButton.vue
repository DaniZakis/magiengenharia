  ...
  <div class="fixed bottom-6 right-6 z-40 flex flex-col items-end gap-3">
    ...
    >
      <button
        ...
        @click="scrollToTop"
        class="w-14 h-14 rounded-full bg-light shadow-lg hover:shadow-xl transition-all hover:scale-110 flex items-center justify-center"
    ...
    >
      <svg class="w-7 h-7" fill="white" viewBox="0 0 32 32">
